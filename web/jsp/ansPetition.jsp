  ...
  <section class="board">
    <div class="content">
      <div class="title_area">
        ...
        <div class="selects">
          <div class="select_wrap" name="standard">
            <select id='order' onchange="window.location.href='/test/AnsBoard?order=' + this.value">
          ...
          <div class="select_wrap" name="field" >
            <select id='category' onchange="window.location.href='/test/AnsBoard?category=' + this.value">
      ...
      <ul class="petition_list">
        <c:forEach items="${anspetList }" var="pet" begin="0">
          <li>
